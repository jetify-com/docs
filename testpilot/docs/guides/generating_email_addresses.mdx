...
If you don't already have one, [sign up for a Mailosaur account](https://mailosaur.com/sign-up/) and retrieve your API credentials. You will need a Mailosaur API Key and Server ID to configure Testpilot.
