...
description: "When writing tests with Testpilot, providing additional context can greatly improve the AI's understanding of your application and test requirements. This guide explains how to use the context feature to create more effective tests."
---
