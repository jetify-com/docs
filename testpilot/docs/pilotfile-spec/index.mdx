...
description: "Your Testpilot configuration is stored in a pilot file, which can be named with various extensions: , , , , or . This file defines test cases and configuration for automated testing of web applications and mobile apps."
---
