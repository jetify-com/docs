---
title: "Setup"
description: "Getting started with Testpilot is quick and easy! Just follow these two simple steps to have everything up and running."
---
...
You can add this line to your shell profile (`.bashrc`, `.zshrc`, etc.) to make it persistent across terminal sessions.
