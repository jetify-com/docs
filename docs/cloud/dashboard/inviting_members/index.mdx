...
1. In the Jetify Dashboard, navigate to the **Members** tab
   ...
   ![Members Tab](/images/docs/cloud/dashboard/inviting_members/docs/assets/images/members_tab-40dac07b43ae1162fd178d9b38fa9b87.png)

2 . To invite a member, enter their email address, and the **Role** you want to assign to them.

![Inviting a Member](/images/docs/cloud/dashboard/inviting_members/docs/assets/images/inviting_member-185c3642afb2ec95b3a0ea74d1fe4039.png)
...
1. Once invited, users will receive an email with instructions on how to join your team. They will
   ...
   ![Invited Member](/images/docs/cloud/dashboard/inviting_members/docs/assets/images/invited_member-b45b2434a407126d929bfb74a0023244.png)
   ...
   ![Active Member](/images/docs/cloud/dashboard/inviting_members/docs/assets/images/active_member-c43971cb25bcc844be7272904bdb435b.png)
...
![Delete a member](/images/docs/cloud/dashboard/inviting_members/docs/assets/images/delete_member-5a80c98ba2e46c130db5188428dd72ba.png)
