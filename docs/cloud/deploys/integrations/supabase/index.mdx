...
description:
  "Supabase is an open source Firebase alternative that provides a managed, highly scalable
  PostgreSQL database and other infrastructure APIs that can support stateless and serverless
  applications. Supabase is easy to connect to using either the Supabase API, or standard PostgreSQL
...
- In the API Settings pane, copy the Project URL and Secret Service Role key
  ![Supabase API UI](/images/docs/cloud/deploys/integrations/supabase/docs/assets/images/supabase-API-f40f4b71577eb6272448b379a96f800b.png)
...
![Secrets set in the Jetify Cloud](/images/docs/cloud/deploys/integrations/supabase/docs/assets/images/supabase-secrets-8bf8278bfacb052c766e14e6ab7e3859.png)
...
```
from supabase import create_client, Clienturl: str = os.getenv('SUPABASE_URL')key: str = os.getenv('SUPABASE_KEY')supabase: Client = create_client(url, key)
```
...
- In the Connection Parameters Settings, copy values needed for connection. Your database password
  ...
  ![Supabase Connection Parameters](/images/docs/cloud/deploys/integrations/supabase/docs/assets/images/connection_parameters-8998ee5136c176392f8132bbef76fe9c.png)
...
![Postgres Secrets](/images/docs/cloud/deploys/integrations/supabase/docs/assets/images/postgres-secrets-6e3fb9b4ba5a504cf4a24e1175458c48.png)
