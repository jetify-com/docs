...
- In the API Settings pane, copy the Project URL and Secret Service Role key
  ![Supabase API UI](./supabase-api-settings.png)
...
![Secrets set in the Jetify Cloud](./supabase-secrets-configuration.png)
...
- In the Connection Parameters Settings, copy values needed for connection. Your database password
  ...
  ![Supabase Connection Parameters](./supabase-connection-parameters.png)
...
![Postgres Secrets](./supabase-postgres-secrets.png)
