...
title: "Introduction"
description:
  "Jetify Deployments is an easy, Devbox friendly way to deploy a stateless application to the cloud
  in a few minutes. Jetify can build and run any Docker container, and provides easy tools for
  configuring your project's secrets, custom domains, and more. Jetify connects to your projects
  Github repo to ensure that you always have the latest version of your application deployed."
---
...
- Set up a [custom domain](/docs/cloud/deploys/custom_domains/) for your application
