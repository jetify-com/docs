...
2. Navigate to the Secrets tab of the Jetify Dashboard
   ![Jetify Dashboard Secrets Tab](/images/docs/cloud/secrets/dashboard_secrets/docs/assets/images/secrets_tab-b1227831ec220ace5b4c0cb52bb2f046.png)
...
![Editing Secrets](/images/docs/cloud/secrets/dashboard_secrets/docs/assets/images/edit_secrets-d57474e57dc301f1b18cea20fd0dd9c9.png)

## Further Reading[​](#further-reading "Direct link to Further Reading")

- [Managing Secrets with the Devbox CLI](/docs/cloud/secrets/secrets_cli/)
