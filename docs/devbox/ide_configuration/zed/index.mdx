...
title: "Zed Editor"
description:
  "Zed is a fast, open source code editor designed for collaboration and AI support, that is
  available for macOS and Linux. Zed has support for loading environments directly from
  Direnv's  files, meaning you can easily use Zed w/ Devbox via our ."
---
...
1. Make sure that you have direnv installed on your host. To use direnv across all your projects, we
   recommend installing it with [devbox global](/docs/devbox/devbox_global/) using
...
```
{  ...  "lsp": {    "<lsp-name>": {      "binary": {"path_lookup": true}    }  },  ...}
```
...
[Edit this page](https://github.com/jetify-com/devbox/tree/main/docs/app/docs/ide_configuration/zed.md)
