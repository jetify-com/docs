...
Devbox visit [our Direnv setup guide](/docs/devbox/ide_configuration/direnv/).
...
2. Setup Devbox shell with Direnv
   ([link to guide](/docs/devbox/ide_configuration/direnv/#setting-up-devbox-shell-and-direnv))
...
[Edit this page](https://github.com/jetify-com/devbox/tree/main/docs/app/docs/ide_configuration/vscode.md)
