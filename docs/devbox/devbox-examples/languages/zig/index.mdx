---
title: "Zig"
description: "Zig projects can be run in Devbox by adding Zig and Nimble to your project."
---
...
[Edit this page](https://github.com/jetify-com/devbox/tree/main/docs/app/docs/devbox-examples/languages/zig.md)
