...
description:
  ...
  project by using our official [RabbitMQ
  Plugin](https://github.com/jetify-com/devbox-plugins/tree/main/rabbitmq)."
---
...
[Edit this page](https://github.com/jetify-com/docs/tree/main/docs/devbox/devbox-examples/databases/rabbitmq/index.mdx)
