...
description:
  "At times, you may need to install a package or library that is only available on a specific
  platform. For example, you may want to install a package that is only available on Linux, while
  still using the same Devbox configuration on your Mac."
---
...
[Edit this page](https://github.com/jetify-com/devbox/tree/main/docs/app/docs/guides/platform_specific_packages.md)
