...
![Process Compose running in the foreground](/images/docs/devbox/guides/services/docs/assets/images/process-compose-tui-ea6c8521f9edc58340be82f160aa7da6.png)
...
```
# Process compose for starting djangoversion: "0.5"processes:  django:   command: python todo_project/manage.py runserver   availability:    restart: "always"
```
...
```bash
devbox services lsNo services currently running. Run `devbox services up` to start them:  django  postgresql
```
...
```
Services running in process-compose:NAME              STATUS          EXIT CODEdjango            Running         0postgresql        Launched        0
```
...
- [**Devbox Services CLI Reference**](/docs/devbox/cli_reference/devbox_services/)
