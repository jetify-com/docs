...
description:
  ...
  using the `devbox run` command. Scripts started with `devbox run` are launched in a interactive
  `devbox shell` that terminates once the script finishes, or is interrupted by CTRL-C."
---
...
[Edit this page](https://github.com/jetify-com/docs/tree/main/docs/devbox/guides/scripts/index.mdx)
