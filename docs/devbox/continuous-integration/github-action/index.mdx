...
description: "This guide explains how to use Devbox in CI/CD using GitHub Actions. The
  [devbox-install-action](https://github.com/marketplace/actions/devbox-installer) will install the
  Devbox CLI and any packages + configuration defined in your `devbox.json` file. You can then run
  tasks or scripts within `devbox shell` to reproduce your environment."
---
...
[Edit this page](https://github.com/jetify-com/docs/tree/main/docs/devbox/continuous-integration/github-action/index.mdx)
