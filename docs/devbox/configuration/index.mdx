...
description:
  "Your devbox configuration is stored in a `devbox.json` file, located in your project's root
  directory. This file can be edited directly, or using the [devbox
  CLI](/docs/devbox/cli-reference/devbox/)."
---
...
`devbox add go@1.19`, or add `go@1.19` to the packages list in your `devbox.json`:
...
[Edit this page](https://github.com/jetify-com/docs/tree/main/docs/devbox/configuration/index.mdx)
