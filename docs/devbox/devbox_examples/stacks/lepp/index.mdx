...
description:
  "An example Devbox shell for NGINX, Postgres, and PHP. This example uses Devbox Plugins for all 3
  packages to simplify configuration"
---
...
```
"env": {    "PGHOST": "/<some-shorter-path>"}
```

[Edit this page](https://github.com/jetify-com/devbox/tree/main/docs/app/docs/devbox_examples/stacks/lepp.md)
