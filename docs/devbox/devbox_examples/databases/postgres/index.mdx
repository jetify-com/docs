...
title: "PostgreSQL"
description:
  "PostgreSQL can be automatically configured by Devbox via the built-in Postgres Plugin. This
  plugin will activate automatically when you install Postgres using"
---
...
```
  "packages": {    "postgresql": "latest",    "glibcLocales": {      "version":   "latest",      "platforms": ["x86_64-linux", "aarch64-linux"]    }  }
```
...
[Edit this page](https://github.com/jetify-com/devbox/tree/main/docs/app/docs/devbox_examples/databases/postgres.md)
