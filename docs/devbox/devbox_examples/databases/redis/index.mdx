...
title: "Redis"
description:
  "Redis can be configured automatically using Devbox's built in Redis plugin. This plugin will
  activate automatically when you install Redis using"
---
...
```bash
REDIS_PORT=6379REDIS_CONF=./devbox.d/redis/redis.conf
```
...
[Edit this page](https://github.com/jetify-com/devbox/tree/main/docs/app/docs/devbox_examples/databases/redis.md)
