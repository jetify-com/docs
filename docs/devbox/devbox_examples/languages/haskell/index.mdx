...
title: "Haskell"
description:
  "Haskell projects that use the Stack Framework can be run in Devbox by adding the Stack and the
  Cabal packages to your project. You may also want to include libraries that Stack requires for
...
```
  "packages": [    "stack@latest",    "cabal-install@latest",    "zlib@latest",    "hpack@latest"  ]
```
...
[Edit this page](https://github.com/jetify-com/devbox/tree/main/docs/app/docs/devbox_examples/languages/haskell.md)
