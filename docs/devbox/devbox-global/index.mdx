...
description:
  ...
  package manager. Devbox Global allows you to add packages to a global `devbox.json.` This is
  useful for installing a standard set of tools you want to use across multiple Devbox Projects."
---
...
<Frame caption="Installing Packages with Devbox Global">
  ![Devbox global package manager](./devbox-global-package-manager.svg)
</Frame>
...
[Edit this page](https://github.com/jetify-com/docs/tree/main/docs/devbox/devbox-global/index.mdx)
