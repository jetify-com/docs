...
description:
  "The following is a list of Environment variables used by Devbox to manage your environment. Some
  of these variables are set by Devbox, while others can be used to manage how Devbox sets up your
  shell."
---
...
[Edit this page](https://github.com/jetify-com/docs/tree/main/docs/devbox/env-variables/index.mdx)
