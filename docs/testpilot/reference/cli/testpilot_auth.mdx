...
- [testpilot auth login](/docs/testpilot/reference/cli/testpilot_auth_login) - Log in to your
  account
- [testpilot auth logout](/docs/testpilot/reference/cli/testpilot_auth_logout) - Log out from your
  account
- [testpilot auth whoami](/docs/testpilot/reference/cli/testpilot_auth_whoami) - Show information
