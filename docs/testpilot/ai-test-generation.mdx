...
description:
  "Generate comprehensive test plans automatically from natural language prompts. Create tests
  faster and discover edge cases with AI assistance."
---
...
cases:
  - id: testcase_01jy56bqacey0vdkt9qtje76q6
    ...
    description:
      Users need to find the package 'go' on nixhub.com and ensure that version 1.24 is listed among
      the search results.
    steps:
