...
description:
  "Write and run your first browser-based test with Testpilot. Learn how to create test plans,
...
cases:
  - id: "testcase_01jy2m0vh8f05vv5qmkkxf6zxt"
    ...
    description:
      "Navigate to news.ycombinator.com, search for Devbox, and click the first search result"
...
![Test Output Example](./testpilot-test-output-example.png)
