---
title: "Testing Android Apps with Testpilot"
sidebarTitle: "Testing Android Apps"
description: "Run automated tests on Android devices and emulators. Set up Appium, configure your device, and execute your first Android test."
---
