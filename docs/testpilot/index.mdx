---
title: "Testpilot: AI Powered End-to-End Testing"
sidebarTitle: "Introduction to Testpilot"
description:
  "Testpilot is an AI testing agent that creates, maintains, and executes tests automatically. Test
  web and mobile apps with visual AI."
---
...
- [Testing Web Apps](/docs/testpilot/getting-started/testing-web-apps) - Create and run
  browser-based tests
...
- [GitLab Integration](/docs/testpilot/integrations/gitlab-cicd) - Run Testpilot in your CI/CD
  pipeline
- [Model Context Protocol](/docs/testpilot/model-context-protocol) - Provide Testpilot with tools
  and context for testing your application
