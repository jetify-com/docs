...
- [Setup Guide](/testpilot/getting_started/setup) - Install Testpilot in minutes
- [Testing Web Apps](/testpilot/getting_started/running_tests) - Create and run browser-based tests
- [Testing Android Apps](/testpilot/getting_started/running_tests_android) - Test Android
  applications
- [Testing iOS Apps](/testpilot/getting_started/running_tests_ios) - Test iOS applications
- [GitLab Integration](/testpilot/gitlab) - Run Testpilot in your CI/CD pipeline
- [Model Context Protocol](/testpilot/getting_started/mcp) - Provide Testpilot with tools and
  context for testing your application
- [Pilotplan Reference](/testpilot/reference/pilotfile_spec) - Learn the test file format
- [Generating Tests](/testpilot/getting_started/generating_tests) - Let AI create tests for you
