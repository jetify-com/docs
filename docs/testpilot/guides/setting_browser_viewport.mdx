...
description:
  "When testing web applications, it's crucial to ensure your site works well across different
  screen sizes. Testpilot makes it easy to define and test with various viewport dimensions directly
  in your test files."
---
