---
title: "How to Add Context to Testpilot Tests"
sidebarTitle: "Adding Context"
description: "Improve test accuracy by adding context to your Testpilot tests. Learn when and how to provide application details and requirements."
---
