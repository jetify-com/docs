...
<CardGroup cols={2}>
<Card title="Adding Context to Tests" icon="info" href="/docs/testpilot/guides/adding_additional_context">
...
<Card
  ...
  icon="mail"
  href="/docs/testpilot/guides/generating_email_addresses"
>
  Integrate with Mailosaur for email-based testing and verification.
</Card>

<Card title="Managing Login Flows" icon="key" href="/docs/testpilot/guides/managing_login_flows">
  Configure authentication to reuse login sessions across test cases.
</Card>

<Card title="Parameterizing Tests" icon="settings" href="/docs/testpilot/guides/parameterizing_tests">
...
<Card
  ...
  icon="monitor"
  href="/docs/testpilot/guides/setting_browser_viewport"
>
  Test your application across different screen sizes and devices.
</Card>

<Card title="Concurrency and Sharding" icon="zap" href="/docs/testpilot/guides/concurrency-and-sharding">
...
- [Getting Started](/docs/testpilot/getting_started/) - If you're new to Testpilot
- [CLI Reference](/docs/testpilot/reference/cli/) - For command-line options and flags
- [Pilotfile Specification](/docs/testpilot/reference/pilotfile_spec) - For configuration details
