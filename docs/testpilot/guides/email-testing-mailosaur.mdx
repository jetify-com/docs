...
description:
  "Test email registration and verification flows with Mailosaur. Generate email addresses, retrieve
  OTP codes, and verify email content."
---
...
If you prefer not to use the Mailosaur integration, you can explicitly specify email addresses in
your test scenarios:
