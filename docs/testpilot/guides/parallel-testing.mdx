...
description:
  "Speed up test execution by running tests in parallel. Configure concurrency for single machines
  and sharding across multiple workers."
---
...
[GitLab Configuration](/docs/testpilot/integrations/gitlab-cicd) for more details on how to set up
sharding in your CI pipeline.
