...
description:
  "Testing authenticated sections of your application is a common requirement. Testpilot makes it
  easy to manage login flows across your test cases so you don't have to repeatedly log in for each
  test."
---
