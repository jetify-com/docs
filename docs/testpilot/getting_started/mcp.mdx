...
description:
  "Testpilot works with Model Context Protocol (MCP) servers, which extend the LLM's capabilities
  during tests. MCP servers can provide access to your team's internal testing APIs, custom scripts,
  or specialized tools, enabling Testpilot to test your application more effectively."
---
