...
description:
  "Best practices for writing effective tests. Learn optimization techniques, testing philosophy,
  and maintainability patterns."
---

Writing high-quality tests ensures your test suite is reliable, maintainable, and provides
meaningful feedback. This section shares best practices and patterns for getting the most out of
Testpilot.

## Testpilot's Testing Philosophy

Testpilot uses AI to test applications visually, the way humans do. This means you should write
tests like you would describe actions to a person:
...
This section provides guidance on writing effective tests, optimizing test performance, and
...
- [Pilotfile Reference](/docs/testpilot/pilotfile-reference) - Complete reference for test file
  format
