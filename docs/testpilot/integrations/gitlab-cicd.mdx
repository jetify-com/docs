...
description:
  "Set up Testpilot in GitLab pipelines. Install the component, configure runners, and automate your
  tests with GitLab CI/CD."
---
...
testpilot-test:
  ...
  script:
    ./bin/testpilot test --outdir=testpilot-out-${CI_NODE_INDEX}
    --shard=${CI_NODE_INDEX}/${CI_NODE_TOTAL} --reporters=junit
  artifacts:
    reports:
      junit: testpilot-out/*.xml
    paths:
